...
literacy <- literacy %>% 
  ...
  mutate(
    read_level_English_and_Ghanian = case_when(
      #assigns 1 if they can read english and ghanian and a 0 to all other individuals
      s2cq1 == 1 & s2cq2 != 1 ~ 1,
      s2cq1 == 1 & s2cq2 == 1 ~ 0,
      s2cq1 == 2 & s2cq2 != 1 ~ 0,
      s2cq1 == 2 & s2cq2 == 1 ~ 0
  ...
  mutate(
    read_level_English = case_when(
      #Assigns 1 if they only read english and a 0 to all other individuals
      s2cq1 == 1 & s2cq2 != 1 ~ 0,
      s2cq1 == 1 & s2cq2 == 1 ~ 1,
      s2cq1 == 2 & s2cq2 != 1 ~ 0,
      s2cq1 == 2 & s2cq2 == 1 ~ 0
  ...
  mutate(
    read_level_Ghanian = case_when(
      #Assigns 1 if they only read ghanian and a 0 to all other individuals
      s2cq1 == 1 & s2cq2 != 1 ~ 0,
      s2cq1 == 1 & s2cq2 == 1 ~ 0,
      s2cq1 == 2 & s2cq2 != 1 ~ 1,
      s2cq1 == 2 & s2cq2 == 1 ~ 0
  ...
  mutate(
    read_level_Unable_to_Read = case_when(
      #Assigns 1 if they don't read either and a 0 to all other individuals
      s2cq1 == 1 & s2cq2 != 1 ~ 0,
      s2cq1 == 1 & s2cq2 == 1 ~ 0,
      s2cq1 == 2 & s2cq2 != 1 ~ 0,
      s2cq1 == 2 & s2cq2 == 1 ~ 1
  ...
  mutate(
    write_level_English_and)Ghanian = case_when(
      #assigns 1 if they can write english and ghanian and a 0 to all other individuals
      s2cq3 == 1 & s2cq4 != 1 ~ 1,
      s2cq3 == 1 & s2cq4 == 1 ~ 0,
      s2cq3 == 2 & s2cq4 != 1 ~ 0,
      s2cq3 == 2 & s2cq4 == 1 ~ 0
  ...
  mutate(
    write_level_English = case_when(
      #assigns 1 if they only write english and a 0 to all other individuals
      s2cq3 == 1 & s2cq4 != 1 ~ 0,
      s2cq3 == 1 & s2cq4 == 1 ~ 1,
      s2cq3 == 2 & s2cq4 != 1 ~ 0,
      s2cq3 == 2 & s2cq4 == 1 ~ 0,
  ...
  mutate(
    write_level_Ghanian = case_when(
      #assigns 1 if they only write ghanian and a 0 to all other individuals
      s2cq3 == 1 & s2cq4 != 1 ~ 0,
      s2cq3 == 1 & s2cq4 == 1 ~ 0,
      s2cq3 == 2 & s2cq4 != 1 ~ 1,
      s2cq3 == 2 & s2cq4 == 1 ~ 0,
  ...
  mutate(
    write_level_Unable_to_Write = case_when(
      #assigns 1 if they can't writein either  and a 0 to all other individuals
      s2cq3 == 1 & s2cq4 != 1 ~ 0,
      s2cq3 == 1 & s2cq4 == 1 ~ 0,
      s2cq3 == 2 & s2cq4 != 1 ~ 0,
      s2cq3 == 2 & s2cq4 == 1 ~ 1,
  ...
  #assigns 1 to individuals who can do calculations and a 0 to all others
  mutate(
    Can_Do_Calculations = case_when(
      s2cq5 == 1 ~ 1,
      s2cq5 == 2 ~ 0,
    )
  )

# Grouped by household we now see the highest level of our 4 levels of literacy  achieved for each household indicated by a 1 value in the highest level category
hh_read <- group_by(literacy, clust, nh) %>% 
  select(clust,nh,read_level_English_and_Ghanian,read_level_English,read_level_Ghanian,read_level_Unable_to_Read)

hh_write <- group_by(literacy, clust, nh) %>% 
  select(clust,nh,write_level_English_and_Ghanian,write_level_English,write_level_Ghanian,write_level_Umable_to_Write)

hh_calc <- group_by(literacy, clust, nh) %>% 
  select(clust,nh,Can_Do_calculations)
