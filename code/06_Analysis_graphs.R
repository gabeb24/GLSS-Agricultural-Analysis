...
model_savannah_lm <- lm(data = hh_agri_profit,
...
model_coastal_lm <- lm(data = hh_agri_profit,
...
model_forest_lm <- lm(data = hh_agri_profit,
...
model_savannah_log <- lm(data = hh_agri_profit,
...
model_coastal_log <- lm(data = hh_agri_profit,
...
model_forest_log <- lm(data = hh_agri_profit,
